# set library path
.libPaths("/home/adrianf/project-folder/nobackup/ADRIAN/metagenomics-power-analyses-tutorial/currbio-bears/r-env/lib/R/library")
...
## ----load-otu----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  otu<-readRDS("/home/adrianf/project-folder/nobackup/ADRIAN/metagenomics-power-analyses-tutorial/currbio-bears/RDS/amr-taxa-bear-0.01-af-bracken-max-highoral-0.01-otu-env-filtered.sub.rds")
...
for (i in c(1:10)) {
  ...
  save(means,file=paste0("/home/adrianf/project-folder/nobackup/ADRIAN/metagenomics-power-analyses-tutorial/currbio-bears/data/p",j,".",i,"means.Rdata"))
  load(paste0("/home/adrianf/project-folder/nobackup/ADRIAN/metagenomics-power-analyses-tutorial/currbio-bears/data/p",j,".",i,"means.Rdata"))
  ...
  ggsave(plot=p1,file=paste0("/home/adrianf/project-folder/nobackup/ADRIAN/metagenomics-power-analyses-tutorial/currbio-bears/figures/p",j,".",i,"-means.png"),dpi=300)
  ...
  save(sds,file=paste0("/home/adrianf/project-folder/nobackup/ADRIAN/metagenomics-power-analyses-tutorial/currbio-bears/data/p",j,".",i,"sds.Rdata"))
  load(paste0("/home/adrianf/project-folder/nobackup/ADRIAN/metagenomics-power-analyses-tutorial/currbio-bears/data/p",j,".",i,"sds.Rdata"))
  ...
  ggsave(plot=p2,file=paste0("/home/adrianf/project-folder/nobackup/ADRIAN/metagenomics-power-analyses-tutorial/currbio-bears/figures/p",j,".",i,"-otu-sd.png"),dpi=300)
  ...
  write.table(cbind(rbind(80,90),rbind(power80,power90)),file=paste0("/home/adrianf/project-folder/nobackup/ADRIAN/metagenomics-power-analyses-tutorial/currbio-bears/results/p",j,".",i,"-bootstrap-power.txt"),row.names = F,quote = F)
  ...
  ggsave(plot=p3,file=paste0("/home/adrianf/project-folder/nobackup/ADRIAN/metagenomics-power-analyses-tutorial/currbio-bears/figures/p",j,".",i,"-omega-power.png"),dpi=300)
}
}